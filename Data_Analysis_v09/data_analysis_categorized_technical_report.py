...
# %% [markdown]
# Cohert Analysis Part

# %%
# I have decided to skip this part because the result I am expected is not there.
# I only see the one record in cohort analysis.
# I have plan to fix those cohort analysis.
...
# data_galaxy['Invoice-Month'] = data_galaxy['REF_DATE'].apply(getting_months)
...
testing_df_AvgHrsWages = df_AvgAnnHrsWrk_2019.copy()
...
testing_df_AvgWeekHrsWrked = df_AvgAnnHrsWrk_2019.copy()
...
testing_df_Hrs_Wrked = df_AvgAnnHrsWrk_2019.copy()
...
testing_df_NumOfJob = df_AvgAnnHrsWrk_2019.copy()
...
testing_df_WagesAndSalaries = df_AvgAnnHrsWrk_2019.copy()
...
# training_df_AvgAnnHrsWrk_ByAge_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
# training_df_AvgAnnHrsWrk_ByGender_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
training_df_AvgAnnHrsWrk_ByImmigrant_FiveProvince = FiveProvinceAnalysis(training_df_AvgAnnHrsWrk_ByImmigrant_Provinces, pd, np, pp)
# training_df_AvgAnnHrsWrk_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
testing_df_AvgAnnHrsWrk_ByImmigrant_FiveProvince = FiveProvinceAnalysis(testing_df_AvgAnnHrsWrk_ByImmigrant_Provinces, pd, np, pp)
# testing_df_AvgAnnHrsWrk_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()

# training_df_AvgAnnHrsWrk_ByIndigenous_FiveProvince = FiveProvinceAnalysis(training_df_AvgAnnHrsWrk_ByIndigenous_Provinces, pd, np, pp)
# training_df_AvgAnnHrsWrk_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
# testing_df_AvgAnnHrsWrk_ByIndigenous_FiveProvince = FiveProvinceAnalysis(training_df_AvgAnnHrsWrk_ByIndigenous_Provinces, pd, np, pp)
# testing_df_AvgAnnHrsWrk_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()

# %%
training_df_AvgAnnWages_ByAge_FiveProvinces = FiveProvinceAnalysis(training_df_AvgAnnWages_ByAge_Provinces, pd, np, pp)
# training_df_AvgAnnWages_ByAge_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
# training_df_AvgAnnWages_ByGender_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
training_df_AvgAnnWages_ByImmigrant_FiveProvince = FiveProvinceAnalysis(training_df_AvgAnnWages_ByImmigrant_Provinces, pd, np, pp)
# training_df_AvgAnnWages_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
testing_df_AvgAnnWages_ByImmigrant_FiveProvince = FiveProvinceAnalysis(testing_df_AvgAnnWages_ByImmigrant_Provinces, pd, np, pp)
# testing_df_AvgAnnWages_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()

# training_df_AvgAnnWages_ByIndigenous_FiveProvince = FiveProvinceAnalysis(training_df_AvgAnnWages_ByIndigenous_Provinces, pd, np, pp)
# training_df_AvgAnnWages_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
# testing_df_AvgAnnWages_ByIndigenous_FiveProvince = FiveProvinceAnalysis(training_df_AvgAnnWages_ByIndigenous_Provinces, pd, np, pp)
# testing_df_AvgAnnWages_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()

# %%
training_df_AvgHrsWages_ByAge_FiveProvinces = FiveProvinceAnalysis(training_df_AvgHrsWages_ByAge_Provinces, pd, np, pp)
# training_df_AvgHrsWages_ByAge_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
# training_df_AvgHrsWages_ByGender_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
training_df_AvgHrsWages_ByImmigrant_FiveProvince = FiveProvinceAnalysis(training_df_AvgHrsWages_ByImmigrant_Provinces, pd, np, pp)
# training_df_AvgHrsWages_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
testing_df_AvgHrsWages_ByImmigrant_FiveProvince = FiveProvinceAnalysis(testing_df_AvgHrsWages_ByImmigrant_Provinces, pd, np, pp)
...
# training_df_AvgWeekHrsWrked_ByAge_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
# training_df_AvgWeekHrsWrked_ByGender_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
training_df_AvgWeekHrsWrked_ByImmigrant_FiveProvince = FiveProvinceAnalysis(training_df_AvgWeekHrsWrked_ByImmigrant_Provinces, pd, np, pp)
# training_df_AvgWeekHrsWrked_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
testing_df_AvgWeekHrsWrked_ByImmigrant_FiveProvince = FiveProvinceAnalysis(testing_df_AvgWeekHrsWrked_ByImmigrant_Provinces, pd, np, pp)
# testing_df_AvgWeekHrsWrked_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
...
# training_df_Hrs_Wrked_ByAge_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
# training_df_Hrs_Wrked_ByGender_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
training_df_Hrs_Wrked_ByImmigrant_FiveProvince = FiveProvinceAnalysis(training_df_Hrs_Wrked_ByImmigrant_Provinces, pd, np, pp)
# training_df_Hrs_Wrked_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
testing_df_Hrs_Wrked_ByImmigrant_FiveProvince = FiveProvinceAnalysis(testing_df_Hrs_Wrked_ByImmigrant_Provinces, pd, np, pp)
# testing_df_Hrs_Wrked_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
...
# training_df_NumOfJob_ByAge_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
# training_df_NumOfJob_ByGender_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
training_df_NumOfJob_ByImmigrant_FiveProvince = FiveProvinceAnalysis(training_df_NumOfJob_ByImmigrant_Provinces, pd, np, pp)
# training_df_NumOfJob_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
testing_df_NumOfJob_ByImmigrant_FiveProvince = FiveProvinceAnalysis(testing_df_NumOfJob_ByImmigrant_Provinces, pd, np, pp)
# testing_df_NumOfJob_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()

# training_df_NumOfJobs_ByIndigenous_FiveProvince = FiveProvinceAnalysis(training_df_NumOfJobs_ByIndigenous_Provinces, pd, np, pp)
# training_df_NumOfJobs_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
# testing_df_NumOfJobs_ByIndigenous_FiveProvince = FiveProvinceAnalysis(training_df_NumOfJobs_ByIndigenous_Provinces, pd, np, pp)
# testing_df_NumOfJobs_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
...
# training_df_WagesAndSalaries_ByAge_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
# training_df_WagesAndSalaries_ByGender_FiveProvinces.print_One_Hot_Encoded_Data_Info()
...
training_df_WagesAndSalaries_ByImmigrant_FiveProvince = FiveProvinceAnalysis(training_df_WagesAndSalaries_ByImmigrant_Provinces, pd, np, pp)
# training_df_WagesAndSalaries_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
testing_df_WagesAndSalaries_ByImmigrant_FiveProvince = FiveProvinceAnalysis(testing_df_WagesAndSalaries_ByImmigrant_Provinces, pd, np, pp)
# testing_df_WagesAndSalaries_ByImmigrant_FiveProvince.print_One_Hot_Encoded_Data_Info()
...
# I have plan to analysis much further in next stage.
...
testing_df_AvgAnnHrsWrk_ByImmigrant_FiveProvince.print_AnalysisResult_ByCharacteristics()
...
testing_df_AvgAnnWages_ByImmigrant_FiveProvince.print_AnalysisResult_ByCharacteristics()
...
testing_df_AvgWeekHrsWrked_ByImmigrant_FiveProvince.print_AnalysisResult_ByCharacteristics()
...
testing_df_Hrs_Wrked_ByImmigrant_FiveProvince.print_AnalysisResult_ByCharacteristics()
...
testing_df_NumOfJob_ByImmigrant_FiveProvince.print_AnalysisResult_ByCharacteristics()
...
testing_df_WagesAndSalaries_ByImmigrant_FiveProvince.print_AnalysisResult_ByCharacteristics()
